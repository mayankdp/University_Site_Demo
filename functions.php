...
function university_files() {
    ...
    wp_enqueue_script('main-university-javascript', get_theme_file_uri('/build/index.js'), array('jquery'), '1.0.0', true);
...
function university_adjest_queries($query) {
...
add_action('pre_get_posts', 'university_adjest_queries');
