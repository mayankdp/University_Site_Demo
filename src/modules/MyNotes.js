        ...
        $.ajax({
            ...
            success: (responce) => {
                ...
                <li data-id="${responce.id}">
                    <input readonly class="note-title-field" value="${responce.title.raw}">
                    <span class="edit-note"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</span>
                    <span class="delete-note"><i class="fa fa-trash-o" aria-hidden="true"></i>Delete</span>
                    <textarea readonly class="note-body-field">${responce.content.raw}</textarea>
            ...
            error: (responce) => {
                if (responce.responseText = "You have reached your note limit.") {
